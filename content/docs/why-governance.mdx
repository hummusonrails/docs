...
To learn more about the Security Council, refer to the [Security Council](/concepts/security-council) concept doc. For a formal articulation of the Security Council's role within ArbitrumDAO's governance process, refer to [The Constitution of the ArbitrumDAO](/dao-constitution).
...
[^1]: Refer to [$ARB airdrop eligibility and distribution specifications](/airdrop-eligibility-distribution) to learn more about the airdrop specifications. Refer to [Arbitrum Sybil Hunting](https://github.com/ArbitrumFoundation/sybil-detection/) for an overview of our Sybil mitigation methodology.

A colleague added this sentence.

Colleague paragraph added during merge test.
