...
function Workspace({ viewer }: { viewer: Viewer }) {
  ...
  }, [document, details, composeContent, mergeLatest, refreshFiles]);
  ...
  const fileProvider = useMemo(
    () => (document ? createFileProvider(document.path, repoPaths) : undefined),
    [document, repoPaths]
  );
          ...
          <>
            ...
            <div className="mx-auto max-w-4xl space-y-4 px-6 py-6">
              ...
              <p className="text-xs text-fd-muted-foreground">
                ...
                glossary term. Press <kbd className="rounded-sm border px-1">⌘S</kbd> to save.
              </p>
            </div>
          </>
        )}
